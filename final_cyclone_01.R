...
#   lapply(NP_index[thirdquarter], function(k){
#     cat (k, "\n")
...
#   lapply(NP_index[secondquarter], function(k){
#     cat (k, "\n")
#     index <- which(whole_track_df$id == k)
#     if (length(index) > 10) {
#       for (l in 1: max(1,(length(index) - 1))) {
...
#   lapply(NP_index[firstquarter], function(k){
#     cat (k, "\n")
#     index <- which(whole_track_df$id == k)
#     if (length(index) > 10) {
#       for (l in 1: max(1,(length(index) - 1))) {
...
#   })
#   
#   lapply(NP_index[outlier_index], function(k){
#     cat (k, "\n")
#     index <- which(whole_track_df$id == k)
#     if (length(index) > 10) {
#       for (l in 1: max(1,(length(index) - 1))) {
...
#   })
#   
#   index <- which(whole_track_df$id == NP_index[median])
